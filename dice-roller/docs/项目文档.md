...
当前目标工程已完成阶段 8 的最小场景与嵌入指南：无 Interface 的 `scenes/test_headless_table.tscn` 经 `IDiceTable` 生成、读 `RollOutcome`、改面。用法见 [嵌入指南.md](./嵌入指南.md)。设置窗 / Toast / Help / 原版 Theme 仍是 7b。
